...
var colNames = ['Show','AirDate','Round','Category','Value','qLength','qHardWords',
	'qDaleChall','aLength','hasMedia','mediaLink','Question','Answer']; // indexed correctly
...
var data = d3.csv("JeopardyDataMini.csv", function(error, data) {
